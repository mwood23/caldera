 ...
 */
		...
		GravityPoint.prototype = (function(o) {
			let s = new Vector(0, 0),
				p;
			for (p in o) s[p] = o[p]; //eslint-disable-line
			return s;
		})({
			gravity: 0.02,
			isMouseOver: false,
 ...
 */
		...
		function resize() {
			const heroContainer = document.getElementById('heroSpaceContainer');
			screenWidth = canvas.width = heroContainer.offsetWidth;
			screenHeight = canvas.height = heroContainer.offsetHeight;
		...
		gui
			...
			.name('Particle Num')
			.onChange(() => {
				let n = (control.particleNum | 0) - particles.length;
